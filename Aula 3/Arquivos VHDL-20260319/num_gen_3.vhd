...
function rand_num_f(width : NATURAL) return std_logic_vector is
	...
	--	Meu numero usp, em decimal, eh 13680612 
    --  Meu numero usp mod 256, em decimal eh 228
...
begin
  your_n_usp := (to_unsigned(228,WIDTH));
...
begin
	...
	--*******************************
		...
		number_s	<=	unsigned (rand_num_f(WIDTH)) AFTER 8 ns	 when (ng_rand_zero = '0') else	
